    ...
    <footer className="footer">
      ...
      <div className="footer__item">
        <img
          ...
          alt="Notificações"
          className="footer__icon"  onClick={() => navigate('/admin/informe')}
        />
        <span>Notificações</span>
      </div>
      <div className="footer__item">
        <img src={TurmasIcon} alt="Turmas" className="footer__icon" onClick={() => navigate('/admin/dashboard')} />
        <span className="footer__item--active">Turmas</span>
      </div>
      <div className="footer__item">
        <img src={GpsIcon} alt="GPS" className="footer__icon" onClick={() => navigate('/admin/location')} />
        <span>Mapa</span>
      </div>
    </footer>
  );
